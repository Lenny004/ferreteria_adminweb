...
export default function ClientesContent() {
  ...
  const query = useQuery({
    ...
    queryFn: () => customersApi.list({ q: search || undefined, take: 100 }),
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base">Listado ({query.data?.total ?? 0})</CardTitle>
        </CardHeader>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <Card className="w-full max-w-md">
            <CardHeader>
              ...
              <CardDescription>Datos fiscales básicos</CardDescription>
            </CardHeader>
            <CardContent>
